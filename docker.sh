...
docker_start() {
    ...
    if [ -z ${ANGULAR_HOST+x} ]; then display_error "var ANGULAR_HOST is unset"; exit; fi
    if [ -z ${ANGULAR_PORT+x} ]; then display_error "var ANGULAR_PORT is unset"; exit; fi
    ...
    then
        ...
        echo '*******************************************************************'
        echo '*******************************************************************'
        echo "* ${GREEN}Running Docker on http://${ANGULAR_HOST}:${ANGULAR_PORT} (Press CTRL+C to quit) ${RESET_COLOR}*"
        echo '*******************************************************************'
        echo '*******************************************************************'
